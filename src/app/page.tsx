...
export default function RendezvousApp() {
  ...
  const [accentColor, setAccentColor] = useState('#7c4a1e')
  ...
  useEffect(() => {
    ...
    const storedAccent = localStorage.getItem('village-accent')
    if (storedAccent) { setAccentColor(storedAccent); applyAccent(storedAccent) }
  ...
  function changeAccent(color: string) {
    ...
    applyAccent(color)
    localStorage.setItem('village-accent', color)
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          {/* Rendezvous mark — two intersecting orbits with a meeting point */}
          <div style={{ position: 'relative', marginTop: -2 }}>
            <svg width="38" height="38" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg"
              style={{ filter: 'drop-shadow(0 2px 8px rgba(124,74,220,0.35)) drop-shadow(0 1px 3px rgba(0,0,0,0.18))', display: 'block' }}>
              {/* Background glow circle */}
              <circle cx="100" cy="100" r="88" fill="url(#rdv-bg)" opacity="0.15"/>
              {/* Orbit ring 1 — tilted ellipse */}
              <ellipse cx="100" cy="100" rx="75" ry="30" stroke="url(#rdv-g1)" strokeWidth="6" fill="none" transform="rotate(-35,100,100)" strokeLinecap="round"/>
              {/* Orbit ring 2 — other axis */}
              <ellipse cx="100" cy="100" rx="75" ry="30" stroke="url(#rdv-g2)" strokeWidth="6" fill="none" transform="rotate(35,100,100)" strokeLinecap="round"/>
              {/* Central meeting node */}
              <circle cx="100" cy="100" r="18" fill="url(#rdv-center)"/>
              <circle cx="100" cy="100" r="10" fill="#fff" opacity="0.95"/>
              {/* Satellite dots */}
              <circle cx="152" cy="74" r="8" fill="#c084fc"/>
              <circle cx="48" cy="126" r="8" fill="#818cf8"/>
              <circle cx="148" cy="130" r="6" fill="#f472b6" opacity="0.8"/>
              <circle cx="52" cy="70" r="6" fill="#34d399" opacity="0.8"/>
              <defs>
                <linearGradient id="rdv-bg" x1="0" y1="0" x2="200" y2="200" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#7c3aed"/>
                  <stop offset="1" stopColor="#db2777"/>
                </linearGradient>
                <linearGradient id="rdv-g1" x1="25" y1="100" x2="175" y2="100" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#818cf8"/>
                  <stop offset="1" stopColor="#c084fc"/>
                </linearGradient>
                <linearGradient id="rdv-g2" x1="25" y1="100" x2="175" y2="100" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#34d399"/>
                  <stop offset="1" stopColor="#f472b6"/>
                </linearGradient>
                <linearGradient id="rdv-center" x1="82" y1="82" x2="118" y2="118" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#7c3aed"/>
                  <stop offset="1" stopColor="#db2777"/>
                </linearGradient>
              </defs>
          ...
          <span style={{ fontWeight: 800, fontSize: '1.15rem', letterSpacing: '-0.5px', background: 'linear-gradient(90deg,#7c3aed,#db2777)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
            rendezvous
          </span>
        </div>
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <button className="icon-btn" style={{ position: 'relative' }} onClick={() => { setNotifModal(true); setNotifUnread(0) }}>
            <Icon name="bell" size={17} />
            {notifUnread > 0 && (
              <span style={{
                position: 'absolute', top: 2, right: 2,
                minWidth: 16, height: 16, background: 'var(--accent2)', borderRadius: 99,
                border: '2px solid var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: '0.55rem', fontWeight: 700, color: '#fff', padding: '0 3px',
                fontFamily: "'Plus Jakarta Sans',sans-serif",
              }}>
          ...
          <div style={{ position: 'relative' }}>
            <button className="icon-btn" onClick={() => setAccentPickerOpen(p => !p)}
              style={{ background: `${accentColor}22`, border: `1.5px solid ${accentColor}`, transition: 'all 0.2s' }}
              title="Change accent color">
              <div style={{ width: 14, height: 14, borderRadius: '50%', background: accentColor, flexShrink: 0 }} />
            </button>
            {accentPickerOpen && (
              <>
                <div onClick={() => setAccentPickerOpen(false)} style={{ position: 'fixed', inset: 0, zIndex: 199 }} />
                <div style={{
                  position: 'absolute', right: 0, top: 42,
                  background: 'var(--surface)', border: '0.5px solid var(--border)',
                  borderRadius: 16, padding: '12px 12px 10px', boxShadow: 'var(--shadow-lg)',
                  zIndex: 200, width: 180,
                  animation: 'fadeUp 0.18s ease both',
                }}>
                  <div style={{ fontSize: '0.68rem', fontWeight: 700, color: 'var(--text3)', letterSpacing: '0.6px', textTransform: 'uppercase', marginBottom: 10 }}>Accent Color</div>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 8 }}>
                    {[
                      { c: '#7c4a1e', name: 'Walnut' },
                      { c: '#2da0d8', name: 'Sky' },
                      { c: '#e03131', name: 'Ruby' },
                      { c: '#2f9e44', name: 'Forest' },
                      { c: '#7950f2', name: 'Violet' },
                      { c: '#f08c00', name: 'Amber' },
                      { c: '#0c8599', name: 'Teal' },
                      { c: '#e64980', name: 'Rose' },
                      { c: '#1971c2', name: 'Ocean' },
                      ...
                      <button key={c} onClick={() => changeAccent(c)} title={name} style={{
                        width: 26, height: 26, borderRadius: '50%', background: c,
                        border: accentColor === c ? '2.5px solid white' : '2px solid transparent',
      ...
      <main className={`with-sidebar${sidebarCollapsed ? ' collapsed' : ''}`} style={{ flex: 1, overflowY: 'auto', paddingBottom: 'calc(83px + 20px)' }}>
        {page === 'home' && <HomeFeed user={user} profile={profile} onAuthRequired={() => setAuthModal('login')} onPlayRadio={playStation} onPlayTV={playTVChannel} currentRadio={radioStation} currentTV={tvChannel} onCreatePost={() => user ? setCreatePostModal(true) : setAuthModal('login')} />}
        {page === 'news' && <NewsPage />}
...
function ShowbizTab() {
  ...
  useEffect(() => { fetchShowbiz() }, [country, category])
...
function HomeFeed({ user, profile, onAuthRequired, onPlayRadio, onPlayTV, currentRadio, currentTV, onCreatePost }: {
  ...
  async function loadPosts() {
    setLoading(true)
    if (feedTab === 'showbiz') {
      // showbiz tab renders its own component — skip post loading
      setLoading(false); return
    }
    // Top posts = ordered by likes, fallback to recent
    ...
    if (liked) {
      ...
      if (post.author_id !== user.id) {
        await supabase.from('notifications').insert({
          user_id: post.author_id, actor_id: user.id,
  ...
  async function toggleSave(postId: string) {
    ...
    if (savedPosts.has(postId)) {
      ...
      setPosts(prev => prev.map(p => p.id === postId ? { ...p, saves_count: Math.max(0, (p.saves_count || 0) - 1) } : p))
      await supabase.from('saved_items').delete().eq('user_id', user.id).eq('item_type', 'post').eq('item_id', postId)
      await supabase.rpc('decrement_saves_count', { post_id: postId })
    } else {
      setSavedPosts(prev => new Set([...prev, postId]))
      setPosts(prev => prev.map(p => p.id === postId ? { ...p, saves_count: (p.saves_count || 0) + 1 } : p))
      await supabase.from('saved_items').insert({ user_id: user.id, item_type: 'post', item_id: postId })
      await supabase.rpc('increment_saves_count', { post_id: postId })
      // Notify post author of save (don't notify self)
      const savedPost = posts.find(p => p.id === postId)
      if (savedPost && savedPost.author_id !== user.id) {
        await supabase.from('notifications').insert({
          user_id: savedPost.author_id, actor_id: user.id,
          type: 'save', post_id: postId,
        })
      }
    }
  }
  ...
  return (
    <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', gap: 24, alignItems: 'flex-start', padding: '0 0 0 0' }}>
      ...
      <div style={{ padding: '12px 16px' }}>
        ...
        {/* Trending strip — only for top posts tab */}
        {feedTab === 'top' && <div style={{ display: 'flex', gap: 8, overflowX: 'auto', padding: '4px 0 12px', scrollbarWidth: 'none' }}>
          {trends.map(t => (
        ...
        {/* Posts */}
        {feedTab === 'top' && !loading && posts.filter(post => activeFilter === 'All' || post.chatroom_tag === activeFilter).map(post => (
...
function PostCard({ post, liked, saved, onLike, onSave, user, profile, onAuthRequired }: {
  ...
  const [liveLikes, setLiveLikes] = useState(post.likes_count)
  const [liveSaves, setLiveSaves] = useState(post.saves_count || 0)
  const [liveReposts, setLiveReposts] = useState(post.reposts_count || 0)
  const menuRef = useRef<HTMLDivElement>(null)
  const postCardRef = useRef<HTMLDivElement>(null)
  const [shareLoading, setShareLoading] = useState(false)
  const [shareCapturing, setShareCapturing] = useState(false)

  // Generate slug from post index (sequential number) — fallback to short uuid
  ...
  async function handleShare() {
    ...
    // Wait a frame so the branding footer renders
    ...
    try {
      ...
      canvas.toBlob(async (blob) => {
        if (!blob) return
        const file = new File([blob], `rendezvous-post-${postSlug}.png`, { type: 'image/png' })
        const shareData: ShareData = {
          title: `${p?.display_name || 'Rendezvous'} on Rendezvous`,
          text: localContent.slice(0, 100) + (localContent.length > 100 ? '…' : ''),
          url: postUrl,
        }
        if (navigator.canShare && navigator.canShare({ files: [file] })) {
          await navigator.share({ ...shareData, files: [file] }).catch(() => {})
        } else if (navigator.share) {
          await navigator.share(shareData).catch(() => {})
        } else {
          // Desktop fallback: download image + copy link to clipboard
          const a = document.createElement('a')
          a.href = URL.createObjectURL(blob)
          a.download = `rendezvous-post-${postSlug}.png`
          a.click()
      ...
      setShareCapturing(false)
      if (navigator.share) {
        await navigator.share({ text: localContent, url: postUrl }).catch(() => {})
      }
      setShareLoading(false)
    }
  }
  ...
  useEffect(() => {
    const channel = supabase.channel(`post-stats-${post.id}`)
      .on('postgres_changes', { event: '*', schema: 'public', table: 'post_likes', filter: `post_id=eq.${post.id}` }, () => {
        supabase.from('posts').select('likes_count,comments_count,reposts_count,saves_count').eq('id', post.id).single().then(({ data }) => {
          if (data) { setLiveLikes(data.likes_count); setCommentCount(data.comments_count); setLiveReposts(data.reposts_count || 0); setLiveSaves(data.saves_count || 0) }
        })
      })
      ...
      .on('postgres_changes', { event: '*', schema: 'public', table: 'saved_items', filter: `item_id=eq.${post.id}` }, () => {
        supabase.from('posts').select('likes_count,comments_count,reposts_count,saves_count').eq('id', post.id).single().then(({ data }) => {
          if (data) { setLiveLikes(data.likes_count); setCommentCount(data.comments_count); setLiveReposts(data.reposts_count || 0); setLiveSaves(data.saves_count || 0) }
        })
      })
  ...
  // Keep live counts in sync with optimistic parent updates
  useEffect(() => { setLiveLikes(post.likes_count) }, [post.likes_count])
  useEffect(() => { setLiveSaves(post.saves_count || 0) }, [post.saves_count])
  useEffect(() => { setLiveReposts(post.reposts_count || 0) }, [post.reposts_count])
  ...
  async function submitComment() {
    ...
    if (data) {
      ...
      // Notify post author of comment (don't notify self)
      if (post.author_id !== user.id) {
        await supabase.from('notifications').insert({
          user_id: post.author_id, actor_id: user.id,
      ...
      // Notify parent comment author of reply (if different from post author & self)
      if (parentId && parentAuthorId && parentAuthorId !== user.id && parentAuthorId !== post.author_id) {
        await supabase.from('notifications').insert({
          user_id: parentAuthorId, actor_id: user.id,
  ...
  return (
    <div ref={postCardRef} className="card" style={{
      padding: 0, marginBottom: 12, overflow: 'hidden',
      ...(shareCapturing ? { borderRadius: 16, boxShadow: '0 8px 32px rgba(0,0,0,0.18)' } : {})
    }}>
      {/* Post header + body */}
      <div style={{ padding: 16, paddingBottom: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: '0.73rem', color: 'var(--text3)', display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              {post.slug && (
                <span style={{ color: 'var(--text3)', fontWeight: 500, opacity: 0.6 }}>#{post.slug}</span>
              )}
              {post.chatroom_tag && (
        ...
        <div onClick={toggleExpand} style={{ cursor: 'pointer' }}>
          <p style={{ fontSize: '0.9rem', lineHeight: 1.6, color: 'var(--text)', marginBottom: (post.media_url || post.media_emoji) ? 12 : 0 }}>
          ...
          {post.media_urls && post.media_urls.length > 1 ? (
            <div style={{
              display: 'grid',
              gridTemplateColumns: post.media_urls.length === 2 ? '1fr 1fr' : post.media_urls.length === 3 ? '1fr 1fr 1fr' : '1fr 1fr',
              gap: 3, borderRadius: 'var(--radius)', overflow: 'hidden', marginTop: 8, marginBottom: 4
            }}>
              {post.media_urls.map((url, i) => (
                <div key={i} style={{ aspectRatio: post.media_urls!.length <= 3 ? '1/1' : i === 0 && post.media_urls!.length === 4 ? '1/1' : '1/1', overflow: 'hidden', position: 'relative' }}>
          ...
          {!post.media_url && !post.media_urls && post.media_emoji && (
            <div style={{ borderRadius: 'var(--radius)', overflow: 'hidden', marginBottom: 12, marginTop: 8, background: 'var(--bg)', aspectRatio: '16/9', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Icon name="palette" size={40} color="var(--text3)" /></div>
          )}
        </div>
      </div>

      {/* Action bar — real-time live counts */}
      <div style={{ display: 'flex', alignItems: 'center', padding: '4px 8px 6px', borderTop: '0.5px solid var(--border)', marginTop: 8, gap: 0 }}>
        {/* Like */}
        <button onClick={onLike} style={{
          display: 'flex', alignItems: 'center', gap: 5, padding: '7px 10px',
          borderRadius: 99, background: 'transparent', border: 'none', cursor: 'pointer',
          color: liked ? '#f4212e' : 'var(--text3)',
          fontSize: '0.8rem', fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 500,
          flex: 1, justifyContent: 'center', transition: 'color 0.18s, background 0.18s',
        }}
        onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.color = '#f4212e'; el.style.background = 'rgba(244,33,46,0.09)' }}
        onMouseLeave={e => { const el = e.currentTarget as HTMLElement; el.style.color = liked ? '#f4212e' : 'var(--text3)'; el.style.background = 'transparent' }}>
          <Icon name={liked ? 'heart-filled' : 'heart'} size={17} color="currentColor" />
          <span style={{ fontSize: '0.78rem', fontWeight: 600, minWidth: 14, color: 'inherit' }}>{liveLikes || 0}</span>
        </button>
        {/* Comment */}
        ...
        onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.color = 'var(--accent)'; el.style.background = 'rgba(45,160,216,0.09)' }}
        onMouseLeave={e => { const el = e.currentTarget as HTMLElement; el.style.color = expanded ? 'var(--accent)' : 'var(--text3)'; el.style.background = 'transparent' }}>
          <Icon name="message-circle" size={17} color="currentColor" />
          <span style={{ fontSize: '0.78rem', fontWeight: 600, minWidth: 14, color: 'inherit' }}>{commentCount || 0}</span>
        </button>
        {/* Repost/Share */}
        <button onClick={handleShare} disabled={shareLoading} style={{
          display: 'flex', alignItems: 'center', gap: 5, padding: '7px 10px',
          borderRadius: 99, background: 'transparent', border: 'none', cursor: shareLoading ? 'wait' : 'pointer',
          color: 'var(--text3)',
          fontSize: '0.8rem', fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 500,
          flex: 1, justifyContent: 'center', transition: 'color 0.18s, background 0.18s',
          opacity: shareLoading ? 0.6 : 1,
        }}
        onMouseEnter={e => { if (!shareLoading) { const el = e.currentTarget as HTMLElement; el.style.color = '#00ba7c'; el.style.background = 'rgba(0,186,124,0.09)' } }}
        onMouseLeave={e => { const el = e.currentTarget as HTMLElement; el.style.color = 'var(--text3)'; el.style.background = 'transparent' }}>
          {shareLoading
            ? <Icon name="loader" size={17} color="currentColor" />
            : <Icon name="share" size={17} color="currentColor" />
          }
          <span style={{ fontSize: '0.78rem', fontWeight: 600, minWidth: 14, color: 'inherit' }}>{liveReposts || 0}</span>
        </button>
        {/* Save/Bookmark */}
        <button onClick={onSave} style={{
          display: 'flex', alignItems: 'center', gap: 5, padding: '7px 10px',
          borderRadius: 99, background: 'transparent', border: 'none', cursor: 'pointer',
          color: saved ? '#1d9bf0' : 'var(--text3)',
          fontSize: '0.8rem', fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 500,
          flex: 1, justifyContent: 'center', transition: 'color 0.18s, background 0.18s',
        }}
        onMouseEnter={e => { const el = e.currentTarget as HTMLElement; el.style.color = '#1d9bf0'; el.style.background = 'rgba(29,155,240,0.09)' }}
        onMouseLeave={e => { const el = e.currentTarget as HTMLElement; el.style.color = saved ? '#1d9bf0' : 'var(--text3)'; el.style.background = 'transparent' }}>
          <Icon name={saved ? 'bookmark-filled' : 'bookmark'} size={17} color="currentColor" />
          <span style={{ fontSize: '0.78rem', fontWeight: 600, minWidth: 14, color: 'inherit' }}>{liveSaves || 0}</span>
        </button>
      </div>

      {/* Share branding watermark — only visible during screenshot capture */}
      {shareCapturing && (
        <div style={{
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          padding: '10px 16px',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <svg width="20" height="20" viewBox="0 0 200 200" fill="none">
              <ellipse cx="100" cy="100" rx="75" ry="30" stroke="#818cf8" strokeWidth="8" fill="none" transform="rotate(-35,100,100)"/>
              <ellipse cx="100" cy="100" rx="75" ry="30" stroke="#34d399" strokeWidth="8" fill="none" transform="rotate(35,100,100)"/>
              <circle cx="100" cy="100" r="18" fill="#7c3aed"/>
              <circle cx="100" cy="100" r="10" fill="#fff" opacity="0.9"/>
            </svg>
            <span style={{ fontWeight: 800, fontSize: '0.88rem', letterSpacing: '-0.3px', color: '#7c3aed' }}>
              rendezvous
            </span>
          </div>
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontSize: '0.62rem', color: '#999', fontWeight: 500, marginBottom: 1 }}>shared from</div>
            <div style={{ fontSize: '0.72rem', color: '#7c3aed', fontWeight: 700 }}>rendezvous.app/post/{postSlug}</div>
          </div>
        </div>
      )}
      ...
      {expanded && (
        <div style={{ borderTop: '0.5px solid var(--border)', background: 'var(--bg)', padding: '12px 16px' }}>
          ...
          {comments.filter(c => !c.parent_comment_id).map(c => (
            <div key={c.id}>
              <CommentRow
                ...
                onQuote={(text, author) => { setCommentText(`> ${author}: "${text}"\n`); setReplyTo(null) }}
          ...
          <div style={{ marginTop: 10 }}>
            {replyTo && (
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 6, paddingLeft: 38 }}>
                <span style={{ fontSize: '0.75rem', color: 'var(--accent)', fontWeight: 600 }}>↩ Replying to {replyTo.name}</span>
                <button onClick={() => setReplyTo(null)} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, lineHeight: 1 }}>
                  <Icon name="x" size={11} color="var(--text3)" />
                </button>
              </div>
            )}
            <div style={{ display: 'flex', gap: 8, alignItems: 'flex-end' }}>
              ...
              <div style={{ flex: 1, background: 'var(--surface)', borderRadius: 18, border: '0.5px solid var(--border)', padding: '8px 12px', display: 'flex', gap: 8, alignItems: 'flex-end' }}>
                <textarea
                  rows={1}
                  placeholder={replyTo ? `Reply to ${replyTo.name}…` : (user ? 'Write a comment…' : 'Sign in to comment…')}
                  value={commentText}
...
function MessagesPage({ user, profile }: { user: any; profile: Profile | null }) {
  ...
  if (!user) return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '80px 20px', gap: 12 }}>
      ...
      <div style={{ fontSize: '0.85rem', color: 'var(--text3)' }}>Connect privately with anyone on Rendezvous</div>
    </div>
  )
...
function DiscoverPage({ user, profile, onAuthRequired }: { user: any; profile: Profile | null; onAuthRequired: () => void }) {
  ...
  async function loadDiscover() {
    ...
    // Trending topics from chatroom tags
    const { data: tagData } = await supabase.from('posts')
      .select('chatroom_tag')
      .not('chatroom_tag', 'is', null)
      .limit(200)
    if (tagData) {
      const counts: Record<string, number> = {}
      tagData.forEach((p: any) => { if (p.chatroom_tag) counts[p.chatroom_tag] = (counts[p.chatroom_tag] || 0) + 1 })
      const sorted = Object.entries(counts).sort((a, b) => b[1] - a[1]).slice(0, 12).map(([tag, count]) => ({ tag, count }))
              ...
              {searchResults.posts.length > 0 && (
                <div>
                  ...
                  {searchResults.posts.map(post => (
                    <PostCard key={post.id} post={post} liked={likedPosts.has(post.id)} saved={savedPosts.has(post.id)} onLike={() => toggleLike(post)} onSave={() => toggleSave(post.id)} user={user} profile={profile} onAuthRequired={onAuthRequired} />
                  ))}
                </div>
              )}
        ...
        <div style={{ padding: '0 16px' }}>
            ...
            <div style={{ display: 'flex', gap: 10, overflowX: 'auto', scrollbarWidth: 'none', paddingBottom: 4 }}>
              {loading ? Array(5).fill(0).map((_, i) => (
                ...
                <div key={acc.id} style={{ flexShrink: 0, textAlign: 'center', width: 80 }}>
                  ...
                  <button style={{ marginTop: 6, padding: '4px 10px', borderRadius: 99, background: 'var(--accent)', color: '#fff', border: 'none', fontSize: '0.65rem', fontWeight: 700, cursor: 'pointer', fontFamily: "'Plus Jakarta Sans',sans-serif" }}>Follow</button>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            {loading ? Array(3).fill(0).map((_, i) => (
              ...
              <PostCard key={post.id} post={post} liked={likedPosts.has(post.id)} saved={savedPosts.has(post.id)}
                onLike={() => toggleLike(post)} onSave={() => toggleSave(post.id)}
    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal-sheet">
        ...
        <div style={{ fontWeight: 800, fontSize: '1.3rem', marginBottom: 4 }}>
          {mode === 'login' ? 'Welcome back' : 'Join Rendezvous'}
        </div>
...
interface Notification {
  ...
  user_id: string
  actor_id: string
  type: 'like' | 'comment' | 'follow' | 'save' | 'reply' | 'mention'
  post_id?: string | null
